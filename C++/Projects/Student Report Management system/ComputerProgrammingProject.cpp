...
using namespace std;
    ...
    double grade, t_g;
    int  a, i, j;
    int mid_grade, ass_grade, final_grade; // single grade calculation input
    char check_torepeat, check_torepeat2, check_tosave, checkstu; // check inputs for while loops
    char A, M, I, F, P; // for the struct input
    fstream document_file;
...
int main()
{
   ...
   cout << endl;
      ...
      cout << "Lidiya Alemayehu Adugna                              894/13  \n";
      cout << "Yonatan Afewerk Teshome                              917/13  \n";
...
void read_stu()
{
   document_file.open("student.txt", ios::in);
    ...
    {
        string line;
        while (getline(document_file, line))
        {
            cout << line << endl;
        }
        document_file.close();
